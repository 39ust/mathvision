...
X_blank = [];
X_blank = [pt1(1,1), pt1(1,2); pt2(1,1), pt2(1,2); pt3(1,1), pt3(1,2); pt4(1,1), pt4(1,2); pt5(1,1), pt5(1,2)]

A = [X_blank(:,1).^2 X_blank(:,1).* X_blank(:,2) X_blank(:,2).^2 X_blank(:,1) X_blank(:,2) ones(5,1)]
[U, S, V] = svd(A)
x = V(:,end)
